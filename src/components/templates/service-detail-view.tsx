          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
            ...
            >
              <div className="group relative flex aspect-square items-center justify-center overflow-hidden rounded-3xl bg-secondary/5 p-12 md:p-16">
                <div className="absolute inset-0 bg-gradient-to-br from-secondary/10 to-transparent opacity-0 transition-opacity duration-700 group-hover:opacity-100" />
                <service.icon
                  strokeWidth={1}
                ...
                {service.process.map((step, idx) => (
                  <div key={step.title} className="relative">
                    ...
                    {idx < service.process.length - 1 && (
                      <div className="absolute top-6 right-[-2rem] left-12 hidden h-px bg-slate-200 md:block" />
                    )}
