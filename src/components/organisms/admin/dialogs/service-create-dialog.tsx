...
interface ServiceCreateDialogProps {
  ...
  onSave: (newService: ServicePackage) => void
}

const ICON_OPTIONS = ['Camera', 'Smartphone', 'PenTool', 'Monitor']

export function ServiceCreateDialog({ open, onOpenChange, onSave }: ServiceCreateDialogProps) {
  ...
  const updateTier = (index: number, updates: Partial<(typeof formData.tiers)[0]>) => {
